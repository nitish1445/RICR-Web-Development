...
const EditAddressModal = ({ isOpen, onClose }) => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      setLoading(true);
      const res = await api.patch("/user/updateAddress", formData);
    ...
    >
      <div
        className="
          ...
          overflow-hidden
          bg-[#FBF3E7]
          shadow-[0_25px_80px_rgba(31,24,17,0.35)]
        "
      >
        {/* Header */}
        ...
        <form onSubmit={handleSubmit}>
              ...
              <div>
                ...
                <textarea
                  ...
                  className={`
                    ...
                    placeholder:text-[#8A7C6A]/60
                    focus:ring-2 focus:ring-[#E8491D]/20
                    ${errors.address ? "ring-1 ring-[#E8491D]" : ""}
                  `}
                />
                ...
                <div>
                  ...
                  <input
                    ...
                    className={`
                      ...
                      placeholder:text-[#8A7C6A]/60
                      focus:ring-2 focus:ring-[#E8491D]/20
                      ${errors.city ? "ring-1 ring-[#E8491D]" : ""}
                    `}
                  />
          ...
          <div className="flex items-center justify-end gap-3 border-t border-[#1F1811]/10 px-5 py-4 sm:px-6">
            ...
            <button
              ...
              disabled={loading}
              className="
                flex min-w-32 cursor-pointer items-center justify-center
                bg-[#E8491D] px-5 py-2.5
                text-xs font-bold uppercase tracking-wide text-[#FBF3E7]
                transition
                hover:bg-[#C93B16]
                disabled:cursor-not-allowed
                disabled:opacity-60
