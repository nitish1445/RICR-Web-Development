...
const RestaurantDisplayMenu = () => {
  ...
  return (
    <>
      <div className="h-100vh bg-amber-100 pt-5">
        <div className="w-5xl rounded shadow-lg mx-auto bg-amber-50">
          <img
            src={restaurantData.photo.url}
            className="w-48 h-48 rounded-l-lg object-cover"
          />
        </div>
        <div className="w-5xl rounded shadow-lg mx-auto mt-5 bg-amber-50">
          <div className="text-(--color-secondary) text-3xl font-bold text-center py-3">
            Menu
          </div>
                      ...
                      <div className="mt-1 text-sm space-y-2">
                        ...
                        <div>
                          ...
                          <span
                            ...
                            style={{
                              backgroundColor:
                                EachItem.type === "veg" || "dairy" ? "#22c55e" : "#ef4444",
                            }}
                          >
                            {EachItem.type}
                          </span>
